...
class LauncherApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self._entry(advanced, "Run ID", self.run_id, 1)
        self._entry(advanced, "Fusion distance cm", self.fusion_distance, 2, width=12)
        self._entry(advanced, "MQTT broker", self.mqtt_broker, 3)
        self._entry(advanced, "MQTT port", self.mqtt_port, 4, width=12)
